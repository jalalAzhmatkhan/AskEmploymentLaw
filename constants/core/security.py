...
# Permissions
PERMISSION_READ_ALL_PERMISSIONS = "read:permissions:all"
PERMISSION_READ_ALL_PERMISSIONS_DESC = "Read all permissions"
PERMISSION_READ_USER_PERMISSIONS = "read:permissions:user"
PERMISSION_READ_USER_PERMISSIONS_DESC = "Read user permissions"
PERMISSION_READ_PERMISSIONS_ME = "read:permissions:me"
PERMISSION_READ_PERMISSIONS_ME_DESC = "Read current user permissions"
PERMISSION_WRITE_PERMISSIONS = "write:permissions"
PERMISSION_WRITE_PERMISSIONS_DESC = "Write permissions"
PERMISSION_UPDATE_PERMISSIONS = "update:permissions"
PERMISSION_UPDATE_PERMISSIONS_DESC = "Update permissions"
PERMISSION_DELETE_PERMISSIONS = "delete:permissions"
PERMISSION_DELETE_PERMISSIONS_DESC = "Delete permissions"

# Role-Permissions Mapping
PERMISSION_READ_ALL_PERMISSIONS_MAPPING = "read:rolepermissions-mapping:all"
PERMISSION_READ_ALL_PERMISSIONS_MAPPING_DESC = "Read all role-permissions mapping"
PERMISSION_READ_ROLE_PERMISSIONS_MAPPING_DTL = "read:rolepermissions-mapping:detail:role"
PERMISSION_READ_ROLE_PERMISSIONS_MAPPING_DTL_DESC = "Read role-permissions mapping by its role"
PERMISSION_READ_USER_PERMISSIONS_MAPPING_DTL = "read:rolepermissions-mapping:detail:user"
PERMISSION_READ_USER_PERMISSIONS_MAPPING_DTL_DESC = "Read role-permissions mapping by user"
PERMISSION_WRITE_ROLE_PERMISSIONS_MAPPING = "write:rolepermissions-mapping"
